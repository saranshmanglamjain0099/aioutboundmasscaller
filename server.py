...
# override=False ensures VPS/Docker/Coolify env vars are always the single source of truth.
# .env file is only used as fallback for local development when vars are not already set.
...
# Serve static CSS/JS for the dashboard
